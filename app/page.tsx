  ...
  return (
    <>
      <div className="flex flex-1 flex-col items-center justify-center p-4">
        ...
        {showIOSInstructions && (
          <div className="w-full max-w-4xl mt-8">
            <div className="relative flex items-center gap-3 px-6 py-4 bg-gray-800/50 border border-gray-700 rounded-lg text-gray-300">
              <svg className="h-5 w-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
              </svg>
              <span className="text-sm">
                To install: Tap <span className="inline-flex items-center"><svg className="h-4 w-4 mx-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z" /></svg> Share</span> then <strong>&quot;Add to Home Screen&quot;</strong>
              </span>
              <button
